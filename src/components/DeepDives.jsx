...
// Four staff-level design notes, grounded in the real kedge/foreguard architecture.
// Essays 3 and 4 are deliberately honest about what's shipped, and about where
// each defense's guarantee actually ends.
const ESSAYS = [
  {
    n: '01',
